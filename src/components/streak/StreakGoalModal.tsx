    ...
    >
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-[1px] bg-[var(--border-primary)]">
            ...
            >
              ...
              <span className="font-ui fs-p-sm uppercase tracking-wide">
                Minutes
              </span>
            </button>
            <button
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-[1px] bg-[var(--border-primary)] mb-3">
            {presets.map((value) => (
              <button
                ...
                className={clsx(
                  'py-3 transition-colors font-mono fs-p-lg',
          ...
          <button
            ...
            className={clsx(
              ...
              'font-ui fs-p-sm uppercase tracking-wide',
              showCustom
                ? 'bg-[var(--bg-secondary)]'
          ...
          {showCustom && (
            <div className="mt-3 flex items-center gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 bg-[var(--bg-primary)] border border-[var(--border-primary)] font-mono fs-p-lg text-center focus:outline-none focus:border-[var(--text-primary)]"
              />
              <span className="font-ui fs-p-sm uppercase text-[var(--text-tertiary)]">
        ...
        <div className="border border-[var(--border-primary)] bg-[var(--bg-secondary)] p-4">
          <p className="font-ui fs-p-sm uppercase tracking-[0.05em] text-[var(--text-tertiary)] mb-2">
            Your Goal
          </p>
