  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Main message */}
        <p className="font-ui fs-p-sm uppercase tracking-[0.15em] text-[var(--text-tertiary)] mb-2">
          Goal Complete
        </p>
        <h2 className="font-display fs-h-lg uppercase tracking-tight mb-4">
          {streakMessage}
        </h2>

        {/* Stats */}
        <div className="border-t border-b border-[var(--border-primary)] py-3 mb-4">
          <p className="font-mono fs-p-lg">
        ...
        <button
          onClick={handleDismiss}
          className="mt-6 px-6 py-2 border border-[var(--border-primary)] font-ui fs-p-sm uppercase tracking-wide hover:bg-[var(--text-primary)] hover:text-[var(--bg-primary)] transition-colors"
        >
          Continue Reading
        </button>
      </div>
